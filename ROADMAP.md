...
- [ ] **Project object catalogue** — Owner: TBD. Expose validated object IDs and names from the selected plate so `bambu_skip_objects` does not depend on an agent guessing numeric identifiers.
